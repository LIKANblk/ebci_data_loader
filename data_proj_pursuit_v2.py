...
class DataProjPursuit_v2(Data):
    def __init__(self,path_to_data,start_epoch = -1.2,end_epoch=1.2,source_sample_rate=500):
        start_epoch = -1.2  # seconds
        end_epoch = 1.2  # seconds
        super(DataProjPursuit_v2, self).__init__(path_to_data,start_epoch,end_epoch,source_sample_rate)
